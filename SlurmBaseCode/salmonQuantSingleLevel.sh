...
salmon_output_dir=$outPath"/RNA_salmon_quant/"
salmonQuant_out_dir=$salmon_output_dir$taxLevel"_quant_"$baseName
echo "salmon quant output dir:"
echo $salmonQuant_out_dir
mkdir $salmonQuant_out_dir
directory_exists $salmonQuant_out_dir
...
echo "Salmon finished successfully" > $salmon_output_dir"finished_salmon.txt"
